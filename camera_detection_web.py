  ...
  <div class="wrap">
    <div class="hero">
      <div>
        ...
        <p>Live annotated compressed camera stream with detector labels beside it.</p>
      </div>
    ...
    <div class="footer">
      The page uses the live annotated compressed topic, so it stays light and avoids raw-image RViz by default.
    </div>
  </div>
...
class CameraDetectionWeb(Node):
    def __init__(self) -> None:
        ...
        self.declare_parameter("camera_topic", "/perception/annotated_image/compressed")
